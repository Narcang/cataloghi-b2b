-- Eseguire su Supabase per abilitare voci menu specializzazione configurabili da admin.
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.profili_specializzazione_opzioni TO authenticated;
