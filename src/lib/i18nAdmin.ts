...
const admin = {
  it: {
    ...
    associati: 'Associati',
    nonAssociati: 'Non associati',
    nessunAssociato: 'Nessun utente associato in questo ruolo.',
    nessunNonAssociato: 'Nessun utente non associato in questo ruolo.',
  ...
  ru: {
    ...
    associati: 'Связанные',
    nonAssociati: 'Не связанные',
    nessunAssociato: 'В этой роли нет связанных пользователей.',
    nessunNonAssociato: 'В этой роли нет несвязанных пользователей.',
  ...
  en: {
    ...
    associati: 'Linked',
    nonAssociati: 'Not linked',
    nessunAssociato: 'No linked users in this role.',
    nessunNonAssociato: 'No unlinked users in this role.',
...
const adminMore: Record<Exclude<AppLocale, 'it' | 'ru' | 'en'>, AdminCopy> = {
  es: {
    ...
    associati: 'Asociados',
    nonAssociati: 'No asociados',
    nessunAssociato: 'Ningún usuario asociado en este rol.',
    nessunNonAssociato: 'Ningún usuario no asociado en este rol.',
  ...
  fr: {
    ...
    associati: 'Associés',
    nonAssociati: 'Non associés',
    nessunAssociato: 'Aucun utilisateur associé dans ce rôle.',
    nessunNonAssociato: 'Aucun utilisateur non associé dans ce rôle.',
  ...
  de: {
    ...
    associati: 'Zugeordnet',
    nonAssociati: 'Nicht zugeordnet',
    nessunAssociato: 'Keine zugeordneten Benutzer in dieser Rolle.',
    nessunNonAssociato: 'Keine nicht zugeordneten Benutzer in dieser Rolle.',
  ...
  nl: {
    ...
    associati: 'Gekoppeld',
    nonAssociati: 'Niet gekoppeld',
    nessunAssociato: 'Geen gekoppelde gebruikers in deze rol.',
    nessunNonAssociato: 'Geen niet-gekoppelde gebruikers in deze rol.',
  ...
  el: {
    ...
    associati: 'Συνδεδεμένοι',
    nonAssociati: 'Μη συνδεδεμένοι',
    nessunAssociato: 'Κανένας συνδεδεμένος χρήστης σε αυτόν τον ρόλο.',
    nessunNonAssociato: 'Κανένας μη συνδεδεμένος χρήστης σε αυτόν τον ρόλο.',
  ...
  pl: {
    ...
    associati: 'Powiązani',
    nonAssociati: 'Niepowiązani',
    nessunAssociato: 'Brak powiązanych użytkowników w tej roli.',
    nessunNonAssociato: 'Brak niepowiązanych użytkowników w tej roli.',
  ...
  uk: {
    ...
    associati: 'Пов’язані',
    nonAssociati: 'Не пов’язані',
    nessunAssociato: 'У цій ролі немає пов’язаних користувачів.',
    nessunNonAssociato: 'У цій ролі немає непов’язаних користувачів.',
