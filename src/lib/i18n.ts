...
const header = {
  it: {
    ...
    installBanner: 'Installa l’app su questo dispositivo',
    lingua: 'Lingua',
  ...
  ru: {
    ...
    installBanner: 'Установите приложение на это устройство',
    lingua: 'Язык',
  ...
  en: {
    ...
    installBanner: 'Install the app on this device',
    lingua: 'Language',
  ...
  es: {
    ...
    cataloghi: 'Catálogos',
    dashboard: 'Dashboard',
    contatti: 'Contactos directos',
    doveSiamo: 'Dónde estamos',
    registrazione: 'Registro',
    areaRiservata: 'Área reservada',
    gestioneUtenti: 'Gestión de usuarios',
    gestioneCataloghi: 'Gestión de catálogos',
    esci: 'Salir',
    accedi: 'Acceder',
    installa: 'Instalar app',
    installBanner: 'Instala la app en este dispositivo',
    lingua: 'Idioma',
    installIos: 'Para instalar: pulsa Compartir y luego «Añadir a la pantalla de inicio».',
    installOther: 'Para instalar: abre el menú del navegador (⋮) y elige «Instalar aplicación».',
    apriMenuEsci: 'Abrir menú para salir',
    chiudi: 'Cerrar',
  },
  fr: {
    menu: 'Menu',
    ...
    installBanner: 'Installer l’application sur cet appareil',
    lingua: 'Langue',
  ...
  de: {
    ...
    installBanner: 'App auf diesem Gerät installieren',
    lingua: 'Sprache',
  ...
  nl: {
    ...
    cataloghi: 'Catalogi',
    dashboard: 'Dashboard',
    contatti: 'Directe contacten',
    doveSiamo: 'Waar we zijn',
    registrazione: 'Registratie',
    areaRiservata: 'Besloten gebied',
    gestioneUtenti: 'Gebruikersbeheer',
    gestioneCataloghi: 'Catalogusbeheer',
    esci: 'Uitloggen',
    accedi: 'Inloggen',
    installa: 'App installeren',
    installBanner: 'Installeer de app op dit apparaat',
    lingua: 'Taal',
    installIos: 'Om te installeren: tik op Delen en daarna «Zet op beginscherm».',
    installOther: 'Om te installeren: open het browsermenu (⋮) en kies «App installeren».',
    apriMenuEsci: 'Menu openen om uit te loggen',
    chiudi: 'Sluiten',
  },
  el: {
    menu: 'Μενού',
    ...
    installBanner: 'Εγκαταστήστε την εφαρμογή σε αυτή τη συσκευή',
    lingua: 'Γλώσσα',
  ...
  pl: {
    ...
    installBanner: 'Zainstaluj aplikację na tym urządzeniu',
    lingua: 'Język',
  ...
  uk: {
    ...
    installBanner: 'Встановіть застосунок на цей пристрій',
    lingua: 'Мова',
...
const home = {
  ...
  es: {
    tecnici: 'Catálogos técnicos',
    fotografico: 'Catálogo fotográfico',
    privacy: 'Política de privacidad',
    termini: 'Términos y condiciones',
    cookie: 'Política de cookies',
    accediPortale: 'Acceso al portal de agentes →',
    scegliLingua: 'Elige el idioma',
    scegliLinguaHelp: 'La interfaz y los catálogos cambian. La cuenta y los vínculos siguen siendo los mismos.',
  },
  fr: {
  ...
  nl: {
    tecnici: 'Technische catalogi',
    fotografico: 'Fotocatalogus',
    privacy: 'Privacybeleid',
    termini: 'Algemene voorwaarden',
    cookie: 'Cookiebeleid',
    accediPortale: 'Naar het agentenportaal →',
    scegliLingua: 'Kies de taal',
    scegliLinguaHelp: 'De interface en catalogi veranderen. Account en koppelingen blijven hetzelfde.',
  },
  el: {
...
const catalogCategoria = {
  ...
  es: {
    tornaHomepage: 'Volver a la página de inicio',
    tornaPortale: 'Volver al portal',
    tornaDashboard: 'Volver al dashboard',
    kicker: 'Catálogos publicados',
    help: 'Elige otra línea desde la página de inicio. Para catálogos reservados y herramientas B2B, entra en el portal.',
    vuoto: 'No hay catálogos publicados en esta categoría de momento.',
    errore: 'Error al cargar los catálogos',
    nessunaImmagine: 'Sin imagen',
    copertina: 'Portada',
    metaTitle: 'Catálogos',
    metaDescription: 'Consulta los catálogos Ladiva publicados en la línea {categoria}.',
  },
  fr: {
  ...
  nl: {
    tornaHomepage: 'Terug naar de homepage',
    tornaPortale: 'Terug naar het portaal',
    tornaDashboard: 'Terug naar het dashboard',
    kicker: 'Gepubliceerde catalogi',
    help: 'Kies een andere lijn op de homepage. Voor besloten catalogi en B2B-tools logt u in op het portaal.',
    vuoto: 'Er zijn momenteel geen gepubliceerde catalogi in deze categorie.',
    errore: 'Fout bij het laden van catalogi',
    nessunaImmagine: 'Geen afbeelding',
    copertina: 'Omslag',
    metaTitle: 'Catalogi',
    metaDescription: 'Bekijk de gepubliceerde Ladiva-catalogi in de lijn {categoria}.',
  },
  el: {
...
const portale = {
  ...
  es: {
    file2dLabel: 'File 2D',
    file2dDesc: 'Archivos técnicos 2D descargables',
    file3dLabel: 'File 3D',
    file3dDesc: 'Archivos técnicos 3D descargables',
    listiniLabel: 'Tarifas públicas',
    listiniDesc: 'Tarifas',
    merchandisingLabel: 'Merchandising',
    merchandisingDesc: 'Condiciones comerciales',
    docsLabel: 'Documentación',
    docsDesc: 'Documentación reservada',
    pptLabel: 'Power Point',
    pptDesc: 'Presentaciones PowerPoint',
    fileOne: 'archivo',
    fileMany: 'archivos',
    home: '← Inicio',
  },
  ...
  nl: {
    file2dLabel: 'File 2D',
    file2dDesc: 'Downloadbare technische 2D-bestanden',
    file3dLabel: 'File 3D',
    file3dDesc: 'Downloadbare technische 3D-bestanden',
    listiniLabel: 'Openbare prijslijsten',
    listiniDesc: 'Prijslijsten',
    merchandisingLabel: 'Merchandising',
    merchandisingDesc: 'Commerciële voorwaarden',
    docsLabel: 'Documentatie',
    docsDesc: 'Besloten documentatie',
    pptLabel: 'Power Point',
    pptDesc: 'PowerPoint-presentaties',
    fileOne: 'bestand',
    fileMany: 'bestanden',
    home: '← Home',
  },
...
const doveSiamo = {
  ...
  es: {
    ...
    titolo: 'Dónde estamos',
    showRoom: 'Show Room',
    produzione: 'Producción',
    deposito: 'Almacén',
    paese: 'Italia',
    tornaHome: '← Volver al inicio',
    metaTitle: 'Dónde estamos',
    metaDescription: 'Dirección, contactos y cómo llegar a Ladiva Ceramica en Carpineti (RE).',
    mapTitle: 'Mapa de Carpineti (RE)',
  },
  fr: {
  ...
  nl: {
    ...
    deposito: 'Magazijn',
    paese: 'Italië',
    tornaHome: '← Terug naar home',
    metaTitle: 'Waar we zijn',
    metaDescription: 'Adres, contacten en hoe u Ladiva Ceramica in Carpineti (RE) bereikt.',
    mapTitle: 'Kaart van Carpineti (RE)',
  },
  el: {
...
const registrazione = {
  it: {
    ...
    tutorialHelp: 'Hai bisogno di aiuto?',
    tutorialLink: 'Segui il tutorial',
    ...
    errInvito: 'Il link di invito non è valido o è già stato utilizzato. Richiedi un nuovo link.',
    societaDaInvito: 'Società presa dall’invito.',
  ...
  ru: {
    ...
    tutorialHelp: 'Нужна помощь?',
    tutorialLink: 'Открыть руководство',
    ...
    errInvito: 'Ссылка-приглашение недействительна или уже использована. Запросите новую ссылку.',
    societaDaInvito: 'Компания взята из приглашения.',
  ...
  en: {
    ...
    tutorialHelp: 'Need help?',
    tutorialLink: 'Follow the tutorial',
    ...
    errInvito: 'The invite link is invalid or has already been used. Please request a new link.',
    societaDaInvito: 'Company taken from the invitation.',
    metaTitle: 'Registration',
    metaDescription: 'Request access to the Ladiva Ceramica B2B portal.',
  },
  es: {
    titolo: 'Registro en el portal',
    descrizione:
      'Rellena el formulario: un administrador confirmará tu cuenta antes del acceso completo a los catálogos reservados.',
    invitatoCome: 'Te han invitado como {ruolo}. Rellena el formulario para completar el registro.',
    ruoloAssegnato: 'Rol asignado:',
    invitoInvalido:
      'El enlace de invitación no es válido o ya se ha usado. Puedes registrarte de todas formas.',
    nome: 'Nombre',
    cognome: 'Apellidos',
    societa: 'Empresa',
    email: 'Email',
    ...
    ok: 'Solicitud enviada. Si el correo de confirmación está activo, revisa la bandeja; tras la confirmación la cuenta esperará la aprobación de un administrador.',
    consensoPrima: 'He leído y acepto la',
    consensoTermini: 'los',
    consensoE: 'y la',
    submit: 'Enviar solicitud de registro',
    submitInvito: 'Registrarse',
    nota: 'Más adelante podremos pedir más datos: se gestionarán en este formulario o en el perfil tras la aprobación.',
    notaInvito: 'El registro se confirma automáticamente y podrás acceder enseguida.',
    haiAccount: '¿Ya tienes una cuenta? Acceder',
    tutorialHelp: '¿Necesitas ayuda?',
    tutorialLink: 'Sigue el tutorial',
    tornaHome: '← Volver a la página pública',
    emailPlaceholder: 'nombre@empresa.com',
    errConsenso: 'Debes aceptar las políticas para continuar.',
    errCampi: 'Rellena todos los campos obligatorios.',
    errPassword: 'La contraseña debe tener al menos 8 caracteres.',
    errEmailExists: 'Este email ya está registrado. Accede o recupera la contraseña.',
    errServer: 'Error de configuración del servidor.',
    errInvito: 'El enlace de invitación no es válido o ya se ha usado. Solicita un enlace nuevo.',
    societaDaInvito: 'Empresa tomada de la invitación.',
    metaTitle: 'Registro',
    metaDescription: 'Solicita acceso al portal B2B de Ladiva Ceramica.',
  },
  fr: {
    ...
    tutorialHelp: 'Besoin d’aide ?',
    tutorialLink: 'Suivre le tutoriel',
    ...
    errInvito: 'Le lien d’invitation n’est pas valide ou a déjà été utilisé. Demandez un nouveau lien.',
    societaDaInvito: 'Société reprise de l’invitation.',
  ...
  de: {
    ...
    tutorialHelp: 'Brauchen Sie Hilfe?',
    tutorialLink: 'Tutorial öffnen',
    ...
    errInvito: 'Der Einladungslink ist ungültig oder wurde bereits verwendet. Bitte einen neuen Link anfordern.',
    societaDaInvito: 'Unternehmen aus der Einladung übernommen.',
    metaTitle: 'Registrierung',
    metaDescription: 'Zugang zum B2B-Portal von Ladiva Ceramica anfragen.',
  },
  nl: {
    titolo: 'Portaalregistratie',
    descrizione:
      'Vul het formulier in: een beheerder bevestigt uw account voordat u volledige toegang tot de besloten catalogi krijgt.',
    invitatoCome: 'U bent uitgenodigd als {ruolo}. Vul het formulier in om de registratie af te ronden.',
    ruoloAssegnato: 'Toegewezen rol:',
    invitoInvalido:
      'De uitnodigingslink is ongeldig of al gebruikt. U kunt zich nog steeds gewoon registreren.',
    nome: 'Voornaam',
    cognome: 'Achternaam',
    societa: 'Bedrijf',
    email: 'E-mail',
    ...
    password: 'Wachtwoord',
    passwordHelp: 'Minimaal 8 tekens.',
    ok: 'Aanvraag verzonden. Als de bevestigingsmail actief is, controleer dan uw inbox; na bevestiging wacht het account op goedkeuring van een beheerder.',
    consensoPrima: 'Ik heb gelezen en accepteer de',
    consensoTermini: 'de',
    consensoE: 'en de',
    submit: 'Registratieaanvraag versturen',
    submitInvito: 'Registreren',
    nota: 'Later kunnen we om extra gegevens vragen: die vult u in dit formulier of in het profiel na goedkeuring.',
    notaInvito: 'De registratie wordt automatisch bevestigd en u kunt meteen inloggen.',
    haiAccount: 'Heeft u al een account? Inloggen',
    tutorialHelp: 'Hulp nodig?',
    tutorialLink: 'Volg de handleiding',
    tornaHome: '← Terug naar de openbare home',
    emailPlaceholder: 'naam@bedrijf.nl',
    errConsenso: 'U moet de beleidsregels accepteren om verder te gaan.',
    errCampi: 'Vul alle verplichte velden in.',
    errPassword: 'Het wachtwoord moet minstens 8 tekens hebben.',
    errEmailExists: 'Dit e-mailadres is al geregistreerd. Log in of herstel het wachtwoord.',
    errServer: 'Serverconfiguratiefout.',
    errInvito: 'De uitnodigingslink is ongeldig of al gebruikt. Vraag een nieuwe link aan.',
    societaDaInvito: 'Bedrijf overgenomen uit de uitnodiging.',
    metaTitle: 'Registratie',
    metaDescription: 'Vraag toegang tot het B2B-portaal van Ladiva Ceramica.',
  },
  el: {
    ...
    tutorialHelp: 'Χρειάζεστε βοήθεια;',
    tutorialLink: 'Ακολουθήστε τον οδηγό',
    ...
    errInvito: 'Ο σύνδεσμος πρόσκλησης δεν είναι έγκυρος ή έχει ήδη χρησιμοποιηθεί. Ζητήστε νέο σύνδεσμο.',
    societaDaInvito: 'Εταιρεία από την πρόσκληση.',
    metaTitle: 'Εγγραφή',
  ...
  pl: {
    ...
    tutorialHelp: 'Potrzebujesz pomocy?',
    tutorialLink: 'Otwórz samouczek',
    ...
    errInvito: 'Link zaproszenia jest nieprawidłowy lub został już użyty. Poproś o nowy link.',
    societaDaInvito: 'Firma pobrana z zaproszenia.',
  ...
  uk: {
    ...
    tutorialHelp: 'Потрібна допомога?',
    tutorialLink: 'Відкрити інструкцію',
    ...
    errInvito: 'Посилання-запрошення недійсне або вже використане. Запросіть нове посилання.',
    societaDaInvito: 'Компанію взято із запрошення.',
...
const catalogAdmin = {
  ...
  es: {
    linguaFile: 'Idioma del archivo',
    linguaHelp: 'Elige el idioma del archivo. Family y los catálogos fotográficos siguen siendo un PDF italiano; tarifas, docs de agentes, merchandising y Power Point se cargan por cada idioma.',
    linguaHelpCondiviso: 'Esta categoría usa un único archivo italiano, visible en todos los idiomas.',
    linguaHelpPerLingua: 'Tarifas, docs de agentes, merchandising y Power Point tienen un PDF dedicado por idioma.',
  },
  fr: {
  ...
  nl: {
    linguaFile: 'Bestandstaal',
    linguaHelp: 'Kies de taal van het bestand. Family en fotocatalogi blijven één Italiaanse PDF; prijslijsten, agentdocs, merchandising en Power Point worden per taal geüpload.',
    linguaHelpCondiviso: 'Deze categorie gebruikt één Italiaans bestand, zichtbaar in alle talen.',
    linguaHelpPerLingua: 'Prijslijsten, agentdocs, merchandising en Power Point hebben een aparte PDF per taal.',
  },
  el: {
...
const login = {
  ...
  es: {
    ...
    descrizione: 'Introduce tus credenciales para ver los catálogos B2B y gestionar proveedores.',
  ...
  nl: {
    titolo: 'Ladiva-login',
    descrizione: 'Voer uw gegevens in om B2B-catalogi te bekijken en leveranciers te beheren.',
...
const dashboard = {
  ...
  es: {
    kicker: 'Dashboard reservado',
    kickerPublic: 'Acceso público',
    titolo: 'Tu área reservada',
    titoloPublic: 'Catálogos y contactos',
    welcomePublic:
      'Consulta los catálogos publicados, Dónde estamos y los contactos directos. Para las áreas reservadas de agentes y socios, entra en el portal.',
    bentornato: 'Bienvenido de nuevo',
    utenteFree: 'Usuario Free',
    inAttesa: 'Pendiente de aprobación',
    gestione: 'Gestión',
    gestioneHelp: 'Elige la sección que quieres gestionar.',
    gestioneUtenti: 'Gestión de usuarios',
    gestioneUtentiHelp:
      'Aprueba registros, gestiona perfiles, invita a nuevos usuarios y consulta los operadores habilitados.',
    gestioneCataloghi: 'Gestión de catálogos',
    gestioneCataloghiHelp:
      'Carga nuevos PDF, cambia estado y visibilidad, actualiza portadas y elimina catálogos.',
    apri: 'Abrir',
    contattiDiretti: 'Tus contactos directos',
    nessunContatto: 'Todavía no tienes ningún contacto directo asignado en la agenda.',
    assistenzaLadiva: 'Asistencia Ladiva',
    chiama: 'Llamar',
    scrivi: 'Escribir',
    contattoSenzaNome: 'Contacto sin nombre',
    tornaHome: '← Volver a la página pública',
    ...
    inserisciAgente: 'Añadir agente manualmente',
    inserisciVenditore: 'Añadir vendedor manualmente',
    inserisciAgenteHelp:
      'Añade manualmente un agente que aún no está registrado: aparecerá enseguida en tu estructura organizativa.',
    inserisciVenditoreHelp:
      'Añade manualmente un vendedor que aún no está registrado: aparecerá enseguida en tu estructura organizativa.',
    inserisciBackOffice: 'Añadir back-office manualmente',
    inserisciBackOfficeHelp:
      'Añade manualmente un perfil Back-Office (mismos poderes que el agente) que aún no está registrado.',
    ilTuoProfilo: 'tu perfil',
    portaleBenvenuto: 'Bienvenido',
    portaleTitolo: 'Área reservada',
  ...
  nl: {
    kicker: 'Besloten dashboard',
    kickerPublic: 'Openbare toegang',
    titolo: 'Uw besloten gebied',
    titoloPublic: 'Catalogi en contacten',
    welcomePublic:
      'Bekijk de gepubliceerde catalogi, Waar we zijn en de directe contacten. Voor besloten gebieden van agenten en partners logt u in op het portaal.',
    bentornato: 'Welkom terug',
    utenteFree: 'Free-gebruiker',
    inAttesa: 'In afwachting van goedkeuring',
    gestione: 'Beheer',
    gestioneHelp: 'Selecteer de sectie die u wilt beheren.',
    gestioneUtenti: 'Gebruikersbeheer',
    gestioneUtentiHelp:
      'Keur registraties goed, beheer profielen, nodig nieuwe gebruikers uit en bekijk de gemachtigde operators.',
    gestioneCataloghi: 'Catalogusbeheer',
    gestioneCataloghiHelp:
      'Upload nieuwe PDF’s, wijzig status en zichtbaarheid, werk omslagen bij en verwijder catalogi.',
    apri: 'Openen',
    contattiDiretti: 'Uw directe contacten',
    nessunContatto: 'U heeft nog geen directe contacten toegewezen in het adresboek.',
    assistenzaLadiva: 'Ladiva-ondersteuning',
    chiama: 'Bellen',
    scrivi: 'Schrijven',
    contattoSenzaNome: 'Contact zonder naam',
    tornaHome: '← Terug naar de openbare home',
    ...
    inserisciAgente: 'Agent handmatig toevoegen',
    inserisciVenditore: 'Verkoper handmatig toevoegen',
    inserisciAgenteHelp:
      'Voeg handmatig een agent toe die nog niet is geregistreerd: die verschijnt meteen in uw organisatiestructuur.',
    inserisciVenditoreHelp:
      'Voeg handmatig een verkoper toe die nog niet is geregistreerd: die verschijnt meteen in uw organisatiestructuur.',
    inserisciBackOffice: 'Back-Office handmatig toevoegen',
    inserisciBackOfficeHelp:
      'Voeg handmatig een Back-Office-profiel toe (dezelfde bevoegdheden als een agent) dat nog niet is geregistreerd.',
    ilTuoProfilo: 'uw profiel',
    portaleBenvenuto: 'Welkom',
    portaleTitolo: 'Besloten gebied',
